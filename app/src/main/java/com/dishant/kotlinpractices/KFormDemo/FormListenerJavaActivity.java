package com.dishant.kotlinpractices.KFormDemo;
...
public class FormListenerJavaActivity extends AppCompatActivity implements OnFormElementValueChangedListener {
    ...
    private void addEditTexts(List<BaseFormElement<?>> elements) {
        ...
        imageView.setOnSelectImage(new Function1<File, Unit>() {
            @Override
            public Unit invoke(File file) {
                if (file != null) {
                    Toast.makeText(FormListenerJavaActivity.this, file.getName(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(FormListenerJavaActivity.this, "Error getting the image", Toast.LENGTH_LONG).show();
                }
        ...
        final FormEmailEditTextElement email = new FormEmailEditTextElement(Tag.Email.ordinal());
        email.setTitle(getString(R.string.email));
        email.setHint(getString(R.string.email_hint));
        email.setValidityCheck(new Function0<Boolean>() {
            @Override
    ...
    private void addMarkComplete(List<BaseFormElement<?>> elements) {
        ...
        button.getValueObservers().add(new Function2<String, BaseFormElement<String>, Unit>() {
            ...
            public Unit invoke(String newValue, BaseFormElement<String> element) {
                FormListenerJavaActivity.this.clearDate();
                return Unit.INSTANCE;
            }
        });
        elements.add(button);
    ...
    private void clearDate() {
        ...
        confirmAlert.setButton(AlertDialog.BUTTON_POSITIVE, this.getString(android.R.string.ok), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (dateToDeleteElement.getValue() != null) {
                    ...
                    if (dateToDelete != null) {
                        Toast.makeText(FormListenerJavaActivity.this, dateToDelete.toString(), Toast.LENGTH_SHORT).show();
        ...
        confirmAlert.setButton(AlertDialog.BUTTON_NEGATIVE, this.getString(android.R.string.cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
            }
        });
